...
export const sendToDiscord = async (title: string, data: Record<string, string>) => {
  const WEBHOOK_URL = process.env.DISCORD_WEBHOOK_URL || 'https://discord.com/api/webhooks/1472525211306823814/XpXC7LvwpDWZko7MoLTQ9IC97VlzDHGqd2wyJljygsuGi1zDnT3_N9NrFVe1mKqDvzlU';
  if (!WEBHOOK_URL) {
